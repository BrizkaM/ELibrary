...
namespace ELibrary.Api.Controllers
{
    ...
    public class BookController : ControllerBase
    {
        ...
        private ActionResult<BookDto> EvaluateCustomerOperation(
            Guid bookId,
            (CustomerBookOperationResult OperationResult, BookDto? UpdatedBook) result,
            string operationType)
        {
            switch (result.OperationResult)
            {
                case CustomerBookOperationResult.NotFound:
                ...
                case CustomerBookOperationResult.Conflict:
                ...
                case CustomerBookOperationResult.OutOfStock:
                ...
                case CustomerBookOperationResult.Success:
