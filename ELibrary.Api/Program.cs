...
try
{
    ...
    // Basic health check - Returns JSON with all check results
    app.MapHealthChecks("/health", new HealthCheckOptions
    {
        ResponseWriter = UIResponseWriter.WriteHealthCheckUIResponse
    });

    // Readiness check - Includes database check (for Kubernetes readiness probe)
    ...
    // Liveness check - Just checks if app is running (for Kubernetes liveness probe)
